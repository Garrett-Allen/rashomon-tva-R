...
print(paste0("Tidyverse timing: ", end_tidy - begin_tidy))
#new



list(t(comboGeneral(c(4,3,3),1)), t(comboGeneral(c(4,3,3),2)))

combinat::combn(c(4,3,3),1)
#normal
begin_tbl <- Sys.time()
data_tbl[, policy_label := .GRP, by = .(arm1,arm2,arm3)]
end_tbl <- Sys.time()

print(paste0("Tidyverse timing: ", end_tbl - begin_tbl))
```
